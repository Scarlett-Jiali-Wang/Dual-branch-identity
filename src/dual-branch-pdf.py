...
def plot_training_curves(history):
    ...
    plt.tight_layout()
    # plt.show()
    plt.savefig('../result/acc-pdf/Digit Recognition Accuracy.pdf', format='pdf', bbox_inches='tight', pad_inches=0.26)
    ...
    plt.tight_layout()
    # plt.show()
    plt.savefig('../result/acc-pdf/Digit Recognition Hinge Loss.pdf', format='pdf', bbox_inches='tight', pad_inches=0.26)
    ...
    plt.tight_layout()
    # plt.show()
    plt.savefig('../result/acc-pdf/User Identification Accuracy.pdf', format='pdf', bbox_inches='tight', pad_inches=0.26)
    ...
    plt.tight_layout()
    # plt.show()
    plt.savefig('../result/acc-pdf/User Identification Hinge Loss.pdf', format='pdf', bbox_inches='tight', pad_inches=0.26)
...
def plot_far_frr(thresholds, fars, frrs, eer, eer_threshold):
    ...
    plt.tight_layout()
    # plt.show()
    plt.savefig('../result/acc-pdf/Authentication FARFRR Curve.pdf', format='pdf', bbox_inches='tight', pad_inches=0.26)
