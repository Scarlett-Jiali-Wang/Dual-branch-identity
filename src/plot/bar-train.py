...
plt.ylabel("Training Latency (s)", fontsize=font_size)
# plt.ylim(0, 42)
...
# Save
# =========================
plt.savefig('../result/bar-train.pdf', format='pdf', bbox_inches='tight', pad_inches=0.26)