...
read_rows = 32 # None 表示读取全部；例如 100 表示只读取前 100 行
...
plt.plot(df["time"], df["pressure"], linewidth=4, color=digit_color[digit])
...
# plt.tight_layout()
# plt.show()
filename = "../result/digit-plot/digit_" + str(digit) +".svg"
